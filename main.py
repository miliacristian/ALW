...
def case_NaN_dataset_classification(dataset_name, strategy, seed=100, perc_NaN=0.1):
    ...
    X, Y = dataset.load_dataset(dataset_name)
    name_setting_file += '_' + str(perc_NaN*10) + '%_NaN'
    name_radar_plot_file += '_' + str(perc_NaN*10) + '%_NaN'
...
if __name__ == '__main__':
    ...
    standardize = False
    normalize = False
    X, Y, scoring, name_setting_file, name_radar_plot_file = case_full_dataset_classification(dataset_name,
                                                                                              standardize=standardize,
                                                                                              normalize=normalize)

    # strategy = 'mean'
    # perc_NaN = 0.1
    # X, Y, scoring, name_setting_file, name_radar_plot_file = case_NaN_dataset_classification(dataset_name,
    #                                                                                          strategy=strategy,
    #                                                                                          seed=seed,
    #                                                                                          perc_NaN=perc_NaN)
